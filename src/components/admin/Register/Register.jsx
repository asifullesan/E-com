...
import {IsEmpty, IsEmail, IsMobile, SuccessToast, ErrorToast} from "../../../helper/formHelper";
import {RegistrationRequest} from "../../../APIRequest/APIAdminRequest";
...
const Registration = () => {
    ...
    const registrationSubmit = () =>{
        ...
        if(!IsEmail(email)){
            ...
            ErrorToast('FirstName must not be empty!');
        }else if(IsEmpty(lastName)){
            ErrorToast('LastName must not be empty!');
        }else if(!IsMobile(mobile)){
            ErrorToast('Mobile must be valid!');
                        ...
                        <div className="card-body">
                            ...
                            <div className="container-fluid m-0 p-0">
                                ...
                                <div className="row mt-2 p-0">
                                    ...
                                    <div className="col-md-8 mt-4 pt-1">

                                        <Link className="text-center ms-3 h6 animated fadeInUp" to="/login">Have account already </Link>
